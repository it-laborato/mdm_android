...
import org.laborato.mdmlab.launcher.db.DownloadTable;
import org.laborato.mdmlab.launcher.db.RemoteFileTable;
import org.laborato.mdmlab.launcher.json.Action;
...
import org.laborato.mdmlab.launcher.pro.worker.DetailedInfoWorker;
import org.laborato.mdmlab.launcher.server.ServerServiceKeeper;
import org.laborato.mdmlab.launcher.service.PushLongPollingService;
import org.laborato.mdmlab.launcher.task.ConfirmDeviceResetTask;
import org.laborato.mdmlab.launcher.task.ConfirmPasswordResetTask;
import org.laborato.mdmlab.launcher.task.ConfirmRebootTask;
import org.laborato.mdmlab.launcher.task.GetRemoteLogConfigTask;
...
import org.laborato.mdmlab.launcher.util.PushNotificationMqttWrapper;
...
public class ConfigUpdater {
    ...
    private void setDefaultLauncher() {
        ...
        if (Utils.isDeviceOwner(context) && config != null) {
            // "Run default launcher" means we should not set Laborato MDM as a default launcher
