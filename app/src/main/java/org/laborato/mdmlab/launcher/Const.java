...
public class Const {
    ...
    public static final String LOG_TAG = "LaboratoMDM";

    public static final int SETTINGS_UNBLOCK_TIME = 180000;
    public static final int PERMISSIVE_MODE_TIME = 180000;

    public static final String LAUNCHER_RESTARTER_PACKAGE_ID = "org.laborato.mdmlab.emuilauncherrestarter";
    ...
    public static final String KIOSK_BROWSER_PACKAGE_NAME = "org.laborato.mdmlab.kiosk";
    public static final String APUPPET_PACKAGE_NAME = "org.laborato.mdmlab.control";
    public static final String APUPPET_SERVICE_CLASS_NAME = "org.laborato.mdmlab.control.GestureDispatchService";

    public static final String QR_BASE_URL_ATTR = "org.laborato.mdmlab.BASE_URL";
    public static final String QR_SECONDARY_BASE_URL_ATTR = "org.laborato.mdmlab.SECONDARY_BASE_URL";
    public static final String QR_SERVER_PROJECT_ATTR = "org.laborato.mdmlab.SERVER_PROJECT";
    public static final String QR_DEVICE_ID_ATTR = "org.laborato.mdmlab.DEVICE_ID";
    public static final String QR_DEVICE_ID_USE_ATTR = "org.laborato.mdmlab.DEVICE_ID_USE";
    public static final String QR_CUSTOMER_ATTR = "org.laborato.mdmlab.CUSTOMER";
    public static final String QR_CONFIG_ATTR = "org.laborato.mdmlab.CONFIG";
    public static final String QR_GROUP_ATTR = "org.laborato.mdmlab.GROUP";
    public static final String QR_OPEN_WIFI_ATTR = "org.laborato.mdmlab.OPEN_WIFI";
    public static final String QR_WORK_PROFILE_ATTR = "org.laborato.mdmlab.WORK_PROFILE";
    ...
    public static final String WORK_TAG_COMMON = "org.laborato.mdmlab.launcher";
