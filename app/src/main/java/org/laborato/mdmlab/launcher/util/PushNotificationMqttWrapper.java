...
import org.laborato.mdmlab.launcher.json.PushMessageJson;
...
public class PushNotificationMqttWrapper {
    ...
    private static final String WORKER_TAG_MQTT_RECONNECT = "org.laborato.mdmlab.launcher.WORK_TAG_MQTT_RECONNECT";
