...
public class PushNotificationWorker extends Worker {
    ...
    private static final String WORK_TAG_PERIODIC = "org.laborato.mdmlab.launcher.WORK_TAG_PUSH_PERIODIC";
    ...
    public Result doWork() {
        ...
        if (pushOptions.equals(ServerConfig.PUSH_OPTIONS_MQTT_WORKER) ||
            ...
            // Re-connection of MQTT client at Laborato MDM startup is implemented in MainActivity
