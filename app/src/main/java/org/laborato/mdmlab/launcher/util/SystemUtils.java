 ...
 * when Laborato MDM is installed as a system app and
 * signed by OS keys
 */
public class SystemUtils {
     ...
     *
     * So it looks like Laborato MDM can never declare itself as a device owner,
     * except when it is running from inside a setup wizard (or declares itself as a setup wizard!)
     * To become a setup wizard, Laborato MDM should be preinstalled in the system, and
