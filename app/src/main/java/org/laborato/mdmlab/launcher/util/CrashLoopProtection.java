...
public class CrashLoopProtection {
    ...
    // We consider it to be an unrecoverable fault if Laborato MDM crashes 5 times or more within a minute
    private static final long LOOP_TIME_SPAN = 60000;
    private static final long LOOP_CRASHES = 3;
    private static final String FAULT_PREFERENCE_NAME = "org.laborato.mdmlab.launcher.fault";
