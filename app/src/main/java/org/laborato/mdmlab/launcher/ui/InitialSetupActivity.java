...
import org.laborato.mdmlab.launcher.databinding.ActivityInitialSetupBinding;
import org.laborato.mdmlab.launcher.helper.CertInstaller;
...
public class InitialSetupActivity extends BaseActivity implements ConfigUpdater.UINotifier {
    ...
    public void onConfigLoaded() {
        // Set Laborato MDM as the default launcher if required
        ...
        if (config != null) {
            ...
            if (Utils.isDeviceOwner(this) &&
                ...
                // Laborato MDM works with default system launcher
                // Run services here
