...
public class MDMService {
     ...
     * @param handler
     * @return true on success and false if no Laborato MDM installed
     */
    ...
    public static class Log {
        ...
        public static void log(int level, String tag, String message) {
            ...
            try {
                ...
                android.util.Log.w(Const.LOG_TAG, "Remote exception while trying to send a log to Laborato MDM!");
                e.printStackTrace();
            }
        }
    ...
    public static class Preferences {
        ...
        public static String get(String attr, String defValue) {
            if (instance == null || instance.mdmApi == null || instance.context == null) {
                // Not initialized, just return
                android.util.Log.w(Const.LOG_TAG, "Connection to Laborato MDM not initialized!");
                return defValue;
            }
            try {
                ...
                android.util.Log.w(Const.LOG_TAG, "Remote exception while trying to get Laborato MDM app preference " + attr);
                e.printStackTrace();
            }
            return defValue;
        }
        ...
        public static boolean set(String attr, String value) {
            ...
            try {
                ...
                android.util.Log.w(Const.LOG_TAG, "Remote exception while trying to set Laborato MDM app preference " + attr + "=" + value);
                e.printStackTrace();
            }
            return false;
        }
        ...
        public static void apply() {
            ...
            try {
                ...
                android.util.Log.w(Const.LOG_TAG, "Remote exception while trying to apply Laborato MDM app preferences!");
                e.printStackTrace();
            }
        }
    }
